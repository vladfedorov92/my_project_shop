...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route
        path={navItemArray[0].route}
        element={<NavDesktop routes={getRoutes()} />}
      >
        <Route index element={<Home />} />
        <Route path={navItemArray[1].route} element={<Customers />} />
        <Route
          path={navItemArray[2].route}
          element={<NavDesktop routes={navProductArray} />}
        >
